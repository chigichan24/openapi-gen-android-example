package net.chigita.openapigenexample.gen.infrastructure

import org.apache.oltu.oauth2.client.request.OAuthClientRequest.AuthenticationRequestBuilder
import org.apache.oltu.oauth2.client.request.OAuthClientRequest.TokenRequestBuilder
import net.chigita.openapigenexample.gen.auth.ApiKeyAuth
import net.chigita.openapigenexample.gen.auth.OAuth
import net.chigita.openapigenexample.gen.auth.OAuth.AccessTokenListener
import net.chigita.openapigenexample.gen.auth.OAuthFlow
    ...
    constructor(
        ...
        authNames.forEach { authName ->
            val auth = when (authName) {
                "api_key" -> ApiKeyAuth("header", "api_key")"petstore_auth" -> OAuth(OAuthFlow.implicit, "http://petstore.swagger.io/oauth/dialog", "", "write:pets, read:pets")
    ...
    */
    ...
    companion object {
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty("net.chigita.openapigenexample.gen.baseUrl", "https://petstore.swagger.io/v2")
        }
    }
}
